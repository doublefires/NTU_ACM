...
- 队内比赛: 包括每周的周赛和不计入在线比赛 rating的平台以外的在线训练.
  ...
  - 线下训练或正式赛: 第一、第二、第三的队伍分别加 30pt, 24pt, 18pt. 队内对所得 pt 进行平分, 向上取整.
  - 在线训练: 第一、第二、第三的队伍(个人)分别加 10pt,8pt, 6pt. 
...
- 专题训练 rating
  ...
  - 专题训练 rating 计算方法: 会定期在VJudge上发布专题训练，时限2个月，专题训练时间会重叠，**期间每做出一题额外加2pt**，**禁止cv**.
