...
- 在线比赛: 
  - codeforces 的 rating
    1. codeforce rating 计算方法: 当前cf Rating值（**取最近5场中rating最高分*2，前五场rating不计入统计，参加场数未达到6场或rating低于1200计分2400**）
    2. **每正式且有效 ( 至少过1题 ) 打一场cf，增加2pt**。
    3. 登记时，**一人只能申报一个codeforces账号**，这意味着**参加场数和 codeforces Rating 将绑定**。
